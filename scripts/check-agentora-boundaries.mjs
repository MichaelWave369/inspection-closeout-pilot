...
const required = {
  architecture: [
    ...
    'PhiOS for identity and persona context',
    'Any separately owned execution service remains external to this Archive',
  ...
  workbenchHtml: [
    ...
    'does not connect to Agentora, Ollama, PhiOS, SQLite, a worker, MCP, webhooks, a browser, a desktop, a repository, an external execution service, or a background process',
